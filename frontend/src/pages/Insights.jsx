...
const articles = [
  {
    ...
    excerpt:
      "As market volatility continues to shape corporate strategy, dealmakers must adapt their due diligence practices to account for new risks and opportunities in an evolving regulatory landscape.",
  ...
  },
  {
    ...
    excerpt:
      "Artificial intelligence is transforming how brands are created, used, and potentially infringed. Here's what businesses need to know to protect their intellectual property in this new era.",
  ...
  },
  {
    ...
    excerpt:
      "The Department of Labor has issued sweeping new guidance on remote work arrangements, wage-and-hour compliance, and multistate employment issues that every employer should understand.",
  ...
  },
  {
    ...
    excerpt:
      "The post-pandemic commercial real estate market presents unique legal challenges for landlords, tenants, and investors. Our analysis of the key issues shaping today's transactions.",
  ...
  },
  {
    ...
    excerpt:
      "As digital footprints become increasingly central to criminal proceedings, understanding how electronic evidence is gathered, preserved, and challenged is more important than ever.",
  ...
  },
  {
    ...
    excerpt:
      "Significant changes to the tax code are taking effect in 2024. Here's our comprehensive breakdown of what business owners and high-net-worth individuals need to know and do now.",
    author: "Priya Nair",
    date: "January 8, 2024",
    read: "8 min",
    featured: false,
  },
  {
    ...
    excerpt:
      "A wave of class action filings is reshaping litigation exposure for businesses across industries. Our litigation team analyzes the key trends and strategies for defense preparedness.",
  ...
  },
  {
    ...
    excerpt:
      "Protecting wealth in complex divorce cases requires early planning and sophisticated legal strategies. Our family law team outlines the key considerations for high-net-worth individuals.",
    author: "Olivia Park",
    ...
    <main className="">
      ...
      <section className="bg-[#0a1628] py-24 relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `radial-gradient(circle at 20% 60%, #c9a84c 0%, transparent 60%)`,
          }}
        />
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-0 border border-slate-200 overflow-hidden group">
              ...
              <div className="lg:col-span-2 bg-gradient-to-br from-[#0a1628] to-[#1a2f5a] min-h-[280px] flex items-center justify-center relative overflow-hidden">
                <div className="text-[#c9a84c]/10 font-serif text-9xl font-light select-none">
                  F
                </div>
        ...
        <div className="max-w-xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="w-full sm:flex-1 bg-white/10 border border-white/20 text-white placeholder-white/30 px-5 py-3 text-sm focus:outline-none focus:border-[#c9a84c] transition-colors"
            />

            <button className="btn-gold-solid w-full sm:w-auto text-xs">
              Subscribe
            </button>
          </div>
        </div>
